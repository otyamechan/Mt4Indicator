 ...
 **********************************************************/  
   ...
   ExtTenkanBuffer[i] = iCustom(NULL,TimeFrame,"span_model",InpTenkan,InpKijun,InpSenkou,0,y);
   ExtKijunBuffer[i]= iCustom(NULL,TimeFrame,"span_model",InpTenkan,InpKijun,InpSenkou,1,y);
   ExtSpanA_Buffer[i]= iCustom(NULL,TimeFrame,"span_model",InpTenkan,InpKijun,InpSenkou,2,y);
   ExtSpanB_Buffer[i]= iCustom(NULL,TimeFrame,"span_model",InpTenkan,InpKijun,InpSenkou,3,y);
//   ExtChikouBuffer[i]= iCustom(NULL,TimeFrame,"span_A",InpTenkan,InpKijun,InpSenkou,4,y);
   ExtSpanA2_Buffer[i]= iCustom(NULL,TimeFrame,"span_model",InpTenkan,InpKijun,InpSenkou,5,y);
   ExtSpanB2_Buffer[i]= iCustom(NULL,TimeFrame,"span_model",InpTenkan,InpKijun,InpSenkou,6,y);
