...
//FastMA
      Buffer1[i]= iMA(NULL,0,FastMA_Period,0,FastMA_Mode,PRICE_CLOSE,i);
//SlowMA
      Buffer2[i]= iMA(NULL,0,SlowMA_Period,0,SlowMA_Mode,PRICE_CLOSE,i); 
   }
