//+------------------------------------------------------------------+
//|                                      Otyame016_MTF_Bollinger_Bar1.mq4 |
//+------------------------------------------------------------------+
#property copyright   "2015,Otyame Trader"
#property description "Otyame016_MTF_Bollinger_Bar1"
...
int BandPrice=PRICE_CLOSE;   // Tenkan-sen
...
int init()
  {
   ...
   shortname = "Otyame016_MTF_Bollinger_Bar1("+TimeFrameStr+")";
