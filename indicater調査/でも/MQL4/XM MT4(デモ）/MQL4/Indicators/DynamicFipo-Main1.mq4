...
int init() {
   ...
   SetIndexStyle(3, DRAW_LINE, STYLE_SOLID, LineWidth + 2);
   SetIndexStyle(4, DRAW_LINE, LineStyle, LineWidth);
   SetIndexStyle(5, DRAW_LINE, STYLE_SOLID, LineWidth + 2);
   ...
   SetIndexLabel(2, "Fibo 0.132 ");
   SetIndexLabel(3, "Fibo 0.276 ");
   SetIndexLabel(4, "Fibo 0.384 ");
   SetIndexLabel(5, "Fibo 0.618 ");
   SetIndexLabel(6, "Fibo 0.764 ");
   SetIndexLabel(7, "Fibo 0.885 ");
...
int start() {
   ...
   for (int li_8 = li_0; li_8 >= 0; li_8--) {
      ...
      g_ibuf_136[li_8] = 0.132 * MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) * gd_160 + g_ibuf_120[li_8];
      g_ibuf_140[li_8] = 0.276 * MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) * gd_160 + g_ibuf_120[li_8];
      g_ibuf_144[li_8] = MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) / 2.0 * gd_160 + g_ibuf_120[li_8];
      g_ibuf_148[li_8] = 0.618 * MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) * gd_160 + g_ibuf_120[li_8];
      g_ibuf_152[li_8] = 0.764 * MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) * gd_160 + g_ibuf_120[li_8];
      g_ibuf_156[li_8] = 0.885 * MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) * gd_160 + g_ibuf_120[li_8];
   }
   return (0);
}
