...
int init() {
   ...
   SetIndexLabel(2, "Fibo 0.5 ");
   SetIndexLabel(3, "Fibo 0.236 ");
...
int start() {
   ...
   for (int li_8 = li_0; li_8 >= 0; li_8--) {
      ...
      g_ibuf_136[li_8] = 0.5 * MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) * gd_160 + g_ibuf_120[li_8];
      g_ibuf_140[li_8] = 0.236 * MathAbs(g_ibuf_124[li_8] - g_ibuf_120[li_8]) * gd_160 + g_ibuf_120[li_8];
