 ...
 **********************************************************/  
   ...
   ExtMapBuffer2[i]=iBands(NULL,TimeFrame,MAPeriod,StdDev,BandsShift,PRICE_CLOSE,MODE_UPPER,y); 
   ExtMapBuffer3[i]=iBands(NULL,TimeFrame,MAPeriod,StdDev,BandsShift,PRICE_CLOSE,MODE_LOWER,y);  
